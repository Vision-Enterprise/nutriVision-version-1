 ...
 * Two clients can end up in conflicting auth states â€” one thinks the
 ...
 * (important security feature â€” keep server secrets without VITE_).
 *
 * YOUR SUPABASE KEYS:
 * â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
 * The ANON key used here is safe to be in browser code. It is
 * designed to be public â€” Supabase's Row Level Security (RLS)
 * policies control what an anonymous or authenticated user can
 * actually read or write. The anon key alone cannot bypass RLS.
 *
 * The SERVICE ROLE key is different â€” it bypasses RLS entirely.
 ...
 * Used when an Admin creates a new staff account so the active Admin session is not replaced in localStorage.
 */
